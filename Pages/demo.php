...
<body>
  ...
  <nav class="navbar bg-dark ">
    ...
    <button class="btn btn-outline-success " style="align-self: flex-start" >Home</button>
        ...
        <div class="card">
          <div class="additional">
            <div class="user-card">
              ...
              <svg width="120" height="110" viewBox="0 0 250 250" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="title desc" class="center">
            ...
            <div class="more-info">
               <h1><?php echo $row['fname']?></h1>  <!-- need to change fname -->
              <div class="coords">
                <span> <strong>Group Name :</strong>  <br> Ganesh AC Services</span>
                <span>Joined January 2019</span>
              </div>
              <div class="coords">
                <span><strong> Role :</strong> <br> Ac repaire</span>
                <span>City, Country<br><p>wardha India</p></span>
              </div>
              <div class="stats">
                <div>
                ...
                <button class=" value btn btn-dark">AppointMe</button>
                </div>
          ...
          <div class="general">
            ...
            <span class="more">100 ₹ per hour</span>
          </div>
        </div>
        <?php }?>
